...
@CucumberOptions(
		tags= "@postcode_search",
		features="src/test/resources/features",
		glue = "stepDefinations",
		plugin = {"json:target/positive/cucumber.json",  "pretty", 
		"html:target/runner/cucumber.html", "com.cucumber.listener.ExtentCucumberFormatter"}
		)
...
public class runner extends AbstractTestNGCucumberTests{
    ...
    public static void setup() {
        ...
        ExtentCucumberFormatter.addSystemInfo("Browser Name", "Google Chrome");
